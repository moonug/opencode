...
export function migrate(info: typeof ConfigV1.Info.Type) {
  return {
    ...
    compaction: info.compaction && {
      ...
      token_threshold: info.compaction.token_threshold,
      context_threshold: info.compaction.context_threshold,
      min_messages: info.compaction.min_messages,
      models: info.compaction.models,
    },
